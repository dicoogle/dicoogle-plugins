 ...
 */
public class InstancesJettyWebService extends HttpServlet implements PlatformCommunicatorInterface {
    private static final Logger logger = LoggerFactory.getLogger(InstancesJettyWebService.class);
    ...
    public InstancesJettyWebService() {
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse response)
        ...
        try {
            ...
            Task<Iterable<SearchResult>> result = this.platform.query("lucene", "SeriesInstanceUID:"+req.getParameter("SeriesInstanceUID"), extraFields);
            rr = result.get();
