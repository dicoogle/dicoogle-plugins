 ...
 */
public class MetadataSeriesJettyWebService implements PlatformCommunicatorInterface {
    private static final Logger logger = LoggerFactory.getLogger(MetadataSeriesJettyWebService.class);
    ...
    public void process(HttpServletRequest req, HttpServletResponse response)
        ...
        try {
            ...
            Task<Iterable<SearchResult>> result = this.platform.query("lucene", "SeriesInstanceUID:"+seriesUID, extraFields);
            rr = result.get();
