...
public class FileStoragePluginSet extends PluginBase {
	private final String name = "file-storage";

	public FileStoragePluginSet() {
        super.storagePlugins.add(new FileStoragePlugin());
	}
